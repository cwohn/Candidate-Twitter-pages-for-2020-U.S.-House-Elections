...
#Get ballotpedia pages for 2020 House Elections in each state
house_url = "https://ballotpedia.org/United_States_House_of_Representatives_elections,_2020"
...
#Return a df with Name, Ballotpedia Page, State, and District for each candidate in the states 2020 U.S. house election
#Pages list candidates like so:
#<h3><span><a>District X<\a><\span><\h3>
# <p><span>General Election<\span><\p>
#<ul>
#.  <li> Candidate 1 (Party) [maybe a check if they won, other icons] <\li>
#.  <li> Candidate 2       ||
#.  <li> Candidate 3       ||
#<\ul>
...
for state_name,state_page in states.items():
    ...
    df = df.append(state_df,ignore_index=True,sort=False)
